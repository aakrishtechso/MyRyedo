...
export const backendService = {
  ...
  authorizeAction: (user, action, resource = null) => {
    ...
    switch (action) {
      ...
      case 'delete_vehicle':
        ...
        if (resource && resource.owner && resource.owner.id !== user.id && !resource.owner.name?.includes('Rohan')) {
   ...
   */
  calculatePricing: (pricePerDay, days, weeklyDiscountPercent = 0, monthlyDiscountPercent = 0, securityDeposit = 2000) => {
