        ...
        {isCancelledSuccess ? (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <img 
                src={vehicle.image || 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&w=400&q=80'} 
                alt={vehicle.name} 
              ...
              <div className="flex-1 space-y-1 text-xs">
                ...
                <div className="flex items-center gap-2 text-gray-500">
                  ...
                  <span>{vehicle.location || 'Local Fleet Hub'}</span>
                </div>
            ...
            <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm space-y-4">
              ...
              {preview?.refundCalculation ? (
                ...
                <div className="p-3 bg-rose-50 border border-rose-100 rounded-2xl text-xs text-rose-700">
                  Unable to load automated calculation. Standard MyRyedo policy guarantees 100% refund if cancelled 24h prior.
                </div>
              ) : null}
              ...
              <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 text-[11px] text-gray-600 space-y-2">
                <span className="font-black text-gray-800 uppercase tracking-wide block">
                  Official MyRyedo Cancellation Policy
                </span>
                <ul className="list-disc pl-4 space-y-1">
                  <li><strong>Grace Period:</strong> 100% refund if cancelled within 1 hour of booking creation.</li>
                  <li><strong>Free Cancellation:</strong> 100% refund if cancelled more than 24 hours before pickup.</li>
                  <li><strong>Standard Notice:</strong> 80% refund (20% fee) if cancelled between 6 and 24 hours before pickup.</li>
                  <li><strong>Late Notice:</strong> 50% refund (50% fee) if cancelled less than 6 hours before pickup.</li>
                  <li><strong>Security Deposits:</strong> Always 100% refundable upon cancellation.</li>
                </ul>
              </div>
            </div>
