...
const DEFAULT_CENTER = { lat: 18.5590, lng: 73.7868 }; // Pune
...
export const MapView = ({
  ...
  const handleSearchSubmit = (e) => {
    ...
    setLocationStatus(`Searching "${searchQuery}" in Pune area...`);
    setTimeout(() => setLocationStatus(null), 3000);
  };
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-2 border-b border-gray-100">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-0.5">
                Real-time verified vehicles around you in Pune & surrounding hubs.
              </p>
            </div>
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-1 text-[10px] font-bold text-amber-600 mt-1">
                            ...
                            <span>{veh.rating || '5.0'} ({veh.tripsCount || 0} trips)</span>
                          </div>
                        </div>
                      </div>
