...
export const ReviewModal = ({
  ...
  const handleSubmit = (e) => {
    ...
    const newReview = {
      ...
      userAvatar: booking.renterAvatar || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&q=80',
      rating,
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex items-center gap-3 bg-[#F7F9FC] p-3 rounded-2xl border border-gray-100">
            <img src={booking.vehicle.images[0]} alt={booking.vehicle.name} className="w-14 h-11 rounded-xl object-cover" />
            <div>
