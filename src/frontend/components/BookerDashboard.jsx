          ...
          >
            ...
            <div className="text-xs space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-gray-900">₹{(selectedInvoiceBooking.platformFee || 160)?.toLocaleString('en-IN')}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500">GST / Taxes:</span>
                <span className="font-bold text-gray-900">₹{(selectedInvoiceBooking.taxes || 240)?.toLocaleString('en-IN')}</span>
              </div>
