        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-0 items-center">
          ...
          <div className="md:col-span-3 relative md:pr-4 md:border-r border-gray-100 flex items-center gap-3">
            ...
            {showLocationDropdown && (
              <div className="absolute top-full left-0 mt-3 w-64 bg-white rounded-2xl shadow-xl border border-gray-100 p-2 z-50 animate-in fade-in slide-in-from-top-1">
                ...
                <div className="space-y-1">
                  {POPULAR_LOCATIONS.map((loc) => (
                    <button
                      ...
                      type="button"
                      onClick={() => {
                        onFilterChange({ searchLocation: loc });
                        setShowLocationDropdown(false);
                      }}
                      className="w-full text-left px-3 py-2 text-xs font-semibold text-gray-700 hover:bg-[#EBF3FE] hover:text-[#1769D1] rounded-xl flex items-center gap-2 cursor-pointer"
                    >
