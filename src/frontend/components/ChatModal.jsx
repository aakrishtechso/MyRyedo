...
export const ChatModal = ({
  ...
  const ownerInfo = matchedVehicle?.owner || {
    ...
    rating: matchedVehicle?.rating || 5.0,
  ...
  const quickReplies = [
    ...
    'Where is the exact meetup point in Wakad?',
    'Does the bike come with helmets?',
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500">
                ⭐ {ownerInfo.rating} · Online · Typically replies {ownerInfo.responseTime}
              </p>
            </div>
          </div>
