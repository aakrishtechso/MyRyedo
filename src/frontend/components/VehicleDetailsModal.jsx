...
export const VehicleDetailsModal = ({
  ...
  const [customHours, setCustomHours] = useState(vehicle.minRentalHours || 3);
  ...
  const calculatedHours = timeDiffMs > 0 ? Math.max(1, Math.round(timeDiffMs / (1000 * 60 * 60))) : (vehicle.minRentalHours || 2);
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-2 text-xs font-bold">
                  <span className="flex items-center gap-1 text-amber-500">
                    ...
                    {vehicle.rating} ({vehicle.tripsCount || 24} trips)
                  </span>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Joined {vehicle.owner.joinedDate || '2023'} · {vehicle.owner.trips || 45} trips hosted
                    </p>
                    <div className="flex items-center gap-3 text-[11px] font-semibold text-gray-600 mt-1">
                      <span>Rating: <strong className="text-gray-900">★ {vehicle.owner.rating}</strong></span>
                      <span>•</span>
                      <span>Replies {vehicle.owner.responseTime || 'within 15 mins'}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  {reviews.length > 0 && (
                    <div className="flex items-center gap-1 text-xs font-black text-amber-500">
                      ...
                      <span>{vehicle.rating || 5.0} out of 5.0</span>
                    </div>
                  )}
                </div>
