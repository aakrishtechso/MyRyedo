        ...
        {isSuccess ? (
          <div className="text-center py-6 space-y-4">
            ...
            <p className="text-xs text-gray-600">
              Thank you for registering. As soon as MyRyedo expands into <strong>{area ? `${area}, ` : ''}{city}</strong>, you'll receive VIP early access and <strong>₹300 in free rental credits</strong>.
            </p>
            <button
              onClick={onClose}
